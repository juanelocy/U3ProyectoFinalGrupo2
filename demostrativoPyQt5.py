...
class ventanaLogin(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Login Grupo 4")
    ...
    def initUI(self):
      ...
      # ==================== FRAME ENCABEZADO ====================
        ...
        labelIcono.setPixmap(QPixmap("").scaled(40, 40, Qt.KeepAspectRatio,
        ...
        labelTitulo = QLabel("<font color='white'>Grupo 4</font>", frame)
        ...
        labelSubtitulo = QLabel("<font color='white'>Sistemas Alertas Tempranas" ".</font>", frame)
